...
function Heading(): JSX.Element {
  // Provide type for the destructured values
  const { language } = useGlobalContext() as GlobalContextType;

  return (
    <div className="heading-container">
      <h2 className="heading-title">
        {language === 'en' ? 'Creating Quality Photos' : 'CREANDO FOTOS DE CALIDAD'}
      </h2>
      <p className="heading-desc">
        {language === 'en'
          ...
          : 'Una foto puede revelar más sobre una persona de lo que pensaba. Al igual que mirar a los ojos, la fotografía puede revelar tu alma. Además, una imagen puede tener diferentes significados'}
      </p>
    </div>
  );
}
